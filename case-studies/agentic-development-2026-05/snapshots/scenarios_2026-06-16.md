# Runtime-Evidence Test Scenarios — 2026-06-16

**When:** 2026-06-16T15:51:23
...
**Result:** trace_id='trace-b03b29e0a2a744c7', chain.trace_id='trace-b03b29e0a2a744c7', matches active_trace file=True

**Evidence:**

```
{"trace_id": "trace-b03b29e0a2a744c7", "chain": {"trace_id": "trace-b03b29e0a2a744c7", "count": 76, "head_hash": "sha256:2d8014e4c126a83ed750b251133d8ba61ec8ad6bb73aad757293c70dbe3e15bf", "valid": true, "broken_at": null, "reason": null}, "file": "trace-b03b29e0a2a744c7"}
```
...
```
path=/tmp/tmpyu4gggoe/active_trace
```
...
**Result:** commit_attestation entry added (count 11→12)
...
**Result:** both resolved to 'trace-b03b29e0a2a744c7'

**Evidence:**

```
{"pipeline": "trace-b03b29e0a2a744c7", "server": "trace-b03b29e0a2a744c7"}
```
...
_Generated 2026-06-16T15:51:23 by_
