# Runtime-Evidence Test Scenarios — 2026-06-07

**When:** 2026-06-07T23:07:38
...
**Result:** trace_id='trace-0572f95941f94f20', chain.trace_id='trace-0572f95941f94f20', matches active_trace file=True

**Evidence:**

```
{"trace_id": "trace-0572f95941f94f20", "chain": {"trace_id": "trace-0572f95941f94f20", "count": 61, "head_hash": "sha256:bef02442d44615a636d97d161a0cddf275e75e27a65a3dc89c0547889784b046", "valid": true, "broken_at": null, "reason": null}, "file": "trace-0572f95941f94f20"}
```
...
```
path=/tmp/claude-1000/tmp59jfpzf8/active_trace
```
...
**Result:** commit_attestation entry added (count 24→25)
...
**Result:** both resolved to 'trace-0572f95941f94f20'

**Evidence:**

```
{"pipeline": "trace-0572f95941f94f20", "server": "trace-0572f95941f94f20"}
```
...
_Generated 2026-06-07T23:07:38 by_
