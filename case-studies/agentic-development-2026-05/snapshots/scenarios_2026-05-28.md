# Runtime-Evidence Test Scenarios — 2026-05-28

**When:** 2026-05-28T01:00:02
...
```
path=/tmp/tmp35by6k3r/active_trace
```
...
**Result:** commit_attestation entry added (count 41→42)
...
```
reason="BLOCKED by Phionyx Stop hook (check_question_grounding):\n  Draft response asks a question that references artifact(s) not opened this turn: ['foo.md']\n  Rule: feedback_read_artifact_before_asking.md —"
```
...
_Generated 2026-05-28T01:00:02 by_
