    ...
    def _initialize_defaults(self):
        ...
        life_planning_rules = [
            ContextRule(
                ...
                memory_tags=["personal_finance", "scheduling", "career_planning", "life_goals"],
                system_prompt_prefix="SYSTEM: Context switched to LIFE_PLANNING. Focus on practical life decisions, personal scheduling, and career planning. Ignore previous technical discussions.",
                priority=10
            )
        ]
        self.definitions[ContextMode.LIFE_PLANNING] = ContextDefinition(
            ...
            description="Life planning, personal organization, career decisions"
        )
