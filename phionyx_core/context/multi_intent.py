...
class MultiIntentDetector:
    ...
    Example:
        Input: "I need to plan my monthly budget and also fix the SDK architecture"
        Output: [
            IntentSegment(text="I need to plan my monthly budget", mode=LIFE_PLANNING),
...
Example:
[
  {{"text": "I need to plan my monthly budget", "mode": "LIFE_PLANNING", "confidence": 0.9}},
