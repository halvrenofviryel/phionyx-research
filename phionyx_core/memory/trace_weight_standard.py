...
try:
    ...
    EchoState2 = None  # type: ignore[assignment,misc]  # optional-import fallback sentinel
...
def trace_weight(
    ...
    """
    if not ECHO_STATE_AVAILABLE or EchoEvent is None:
...
def calculate_trace_strength_from_tags(
    ...
    """
    if not ECHO_STATE_AVAILABLE or EchoState2 is None:
