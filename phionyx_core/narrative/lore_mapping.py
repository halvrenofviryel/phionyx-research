"""
Inspection → Çark ve Terazi Lore Mapping Table
==========================================

This mapping table is the intellectual core of the Resilience Platform.
It systematically converts Inspection findings and real-world psychological concepts
...
class RiskLevel(str, Enum):
    """Inspection risk level classification."""
    LOW = "low"
    MEDIUM = "medium"
    HIGH = "high"
    CRITICAL = "critical"
...
@dataclass
class LoreMapping:
    """Single mapping entry: Inspection finding → Lore equivalent."""
...
EMOTIONAL_RISK_MAPPING: List[LoreMapping] = [
    LoreMapping(
        inspection_finding="Anxiety (exam, social)",
    ...
    LoreMapping(
        inspection_finding="Panic Response",
    ...
    LoreMapping(
        inspection_finding="Low Self-Esteem",
    ...
    LoreMapping(
        inspection_finding="Shame / Guilt",
    ...
    LoreMapping(
        inspection_finding="Anger Outbursts",
    ...
    LoreMapping(
        inspection_finding="Emotional Numbness",
    ...
    LoreMapping(
        inspection_finding="Hopelessness",
...
SOCIAL_BEHAVIOR_MAPPING: List[LoreMapping] = [
    LoreMapping(
        inspection_finding="Peer Conflict",
    ...
    LoreMapping(
        inspection_finding="Bullying (victim)",
    ...
    LoreMapping(
        inspection_finding="Bullying (perpetrator)",
    ...
    LoreMapping(
        inspection_finding="Social Withdrawal",
    ...
    LoreMapping(
        inspection_finding="Attachment Issues",
    ...
    LoreMapping(
        inspection_finding="Authority Conflict",
...
ACADEMIC_BEHAVIOR_MAPPING: List[LoreMapping] = [
    LoreMapping(
        inspection_finding="Exam Stress",
    ...
    LoreMapping(
        inspection_finding="Low Engagement",
    ...
    LoreMapping(
        inspection_finding="Attendance Risk",
    ...
    LoreMapping(
        inspection_finding="Concentration Issues",
    ...
    LoreMapping(
        inspection_finding="Task Avoidance",
...
def get_lore_mapping(inspection_finding: str) -> Optional[LoreMapping]:
    """Get lore mapping for a given Inspection finding."""
    all_mappings = (
    ...
    for mapping in all_mappings:
        if mapping.inspection_finding.lower() == inspection_finding.lower():
            return mapping
