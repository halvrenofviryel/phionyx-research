...
| [`iso-42001.md`](iso-42001.md) | ISO/IEC 42001:2023 AI Management System — 15 control-type rows (0 Full / 9 Partial / 6 Gap — corrected 2026-08-02) — **draft**, Annex A identifier accuracy requires paid-text verification | v0.3.0 | **Public (draft)** |
