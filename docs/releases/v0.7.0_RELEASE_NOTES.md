...
- **EU AI Act Article 12 template** — candidate input; founder-paced per individual decision.
...
- *Compliance Evidence Drafts: From Envelope Chain to Framework-Shaped Report*
- *HearthOS Bounded-Authority: A Wire-Level Reference for Family-Decision AI*
...
- Reviewer-aligned supplement (2026-05-26) timeline recalibration that compressed v0.7.0 by ~5 months.- Pre-commit governance hooks (12 hooks live since 2026-05-26) for keeping the development chain dense.
